"""
Django settings for codecompanion project.
...
ALLOWED_HOSTS = ['e6906698bed0.ngrok.io', '127.0.0.1', 'codecompanionapp.herokuapp.com']
...
ROOT_URLCONF = 'codecompanion.urls'
...
WSGI_APPLICATION = 'codecompanion.wsgi.application'
...
if 'USER_AWS' in os.environ:
    ...
    STATICFIELDS_STORAGE = 'custom_storages.StaticStorage'
