...
Code Companion uses Git version control, with the code stored on GitHub that automatically deploys to Heroku. AWS has been integrated for storage of media asses such as images, and is automatically deployed to the S3 bucket on every Git push. 
